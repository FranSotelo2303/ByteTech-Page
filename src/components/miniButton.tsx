...
const Button = (props: ButtonProps) => {
  ...
  const defaultStyles =
    "rounded-[18px] flex capitalize items-center justify-center gap-[9px] w-fit text-white text-base lg:text-sm font-semibold font-['Jost'] leading-snug tracking-tight px-10 py-2 md:px-[44px] md:py-[10px]";
